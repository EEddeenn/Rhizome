...
│   ├── app/editor/      # Standalone editor route
│   ├── components/
...
│   │   ├── pages/       # Page components (EntryPage, EntryPageClient)
│   │   ├── providers/   # Provider wrappers (ClientProviders)
...
| [docs/editor.md](./docs/editor.md) | Web editor setup and usage guide |
