...
For embedding code in diagrams, see [[Diagrams#Sequence Diagrams]] for sequence and class diagrams. For mathematical algorithms, see [[Mathematical Notation#Calculus]].
</Callout>
