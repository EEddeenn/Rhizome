...
Example: [[Embeds and Anchors#Combined Syntax]] opens the combined syntax reference.

## Use Cases

### Following Citation Chains

When reading [[Building a Second Brain]], you might click through to [[Knowledge Graph Basics#Core Concepts]], then to [[Welcome to Rhizome#Wiki-links]] — each opening in a new pane while preserving your reading history.
